...
class SpriteSymbol extends Sprite {
	...
	private function setFilterData(data:FilterData):Void {
    	...
    	if (data.type == "Blur") {
        	filters.push(new BlurFilter(data.blurX, data.blurY, data.quality));
    	}
    	else if (data.type == "Glow") {
        	filters.push(new GlowFilter(
            	data.color, data.alpha, data.blurX, data.blurY, 
            	data.strength, data.quality, data.inner, data.knockout
        	));
    	}
	...
	private function setColor(data:ColorData):Void {
    	...
    	if (data != null) {
        	newTransform.redOffset = data.redOffset;
        	newTransform.greenOffset = data.greenOffset;
        	newTransform.blueOffset = data.blueOffset;
        	newTransform.alphaOffset = data.alphaOffset;

        	newTransform.redMultiplier = data.redMultiplier;
        	newTransform.greenMultiplier = data.greenMultiplier;
        	newTransform.blueMultiplier = data.blueMultiplier;
        	newTransform.alphaMultiplier = data.alphaMultiplier;
    	}
