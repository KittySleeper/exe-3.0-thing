...
class BaseStage extends FlxBasic
{
	...
	public var isEncoreMode(get, never):Bool;
	public var isSoundTest(get, never):Bool;
	...
	inline private function get_isEncoreMode() return PlayState.isEncoreMode;
	inline private function get_isSoundTest() return PlayState.isSoundTest;
